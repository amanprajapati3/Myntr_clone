...
const Bag = () => {
  return (
    <>
    <div className='flex justify-center ml-2 sm:ml-0 '>
      <div>
      <div className='flex gap-3 py-4 sm:text-2xl font-semibold'>
      ...
      <div className='sm:mt-24'>
        ...
        <a href="/wishlist">
        <button className='my-4 p-2 ml-8 border-2 border-pink-600 sm:text-xl text-pink-600 hover:text-white hover:bg-pink-600 rounded-lg hover:ease-out hover:duration-700'>ADD ITEMS FROM WISHLIST</button></a>
      </div>
      </div>
    </div>
    </>
