  ...
  return (
    <>
      <div className="flex justify-center sm:mt-32 mt-12">
        <div>
          <h1 className="text-xl font-bold py-3">PLEASE LOG IN</h1>
          ...
          <center>
            <button className="py-2 px-10 text-xl text-blue-600 border-2 border-gray-700 hover:text-white hover:bg-blue-600 rounded-lg hover:ease-out hover:duration-700"><a href="/login">LOGIN</a></button>
          </center>
        </div>
      </div>
    </>
